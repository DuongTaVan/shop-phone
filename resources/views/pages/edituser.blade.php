        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form action="clear/postEditUser/{{$user->id}}" method='POST'>
                            @csrf
                            ...
                            <div class="col-md-8 col-lg-8 col-lg-offset-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="level" class="form-control" value="">
                                        <option @if($user->level ==0) selected @endif value="0">admin</option>
                                        <option @if($user->level ==1) selected @endif value="1">user</option>
                                        <option @if($user->level ==2) selected @endif value="2">starr</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
